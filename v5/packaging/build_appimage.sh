...
mkdir -p "$APPDIR/usr/share/darkie-suite"
...
exec python3 tool.py --gui
APPRUN
chmod +x "$APPDIR/AppRun"
cat > "$APPDIR/darkie-suite.desktop" << 'DESKTOP'
[Desktop Entry]
...
./appimagetool AppDir "$DIR/dist/Darkie-Suite-v5-x86_64.AppImage" 2>/dev/null || echo "appimagetool not available. Install from https://github.com/AppImage/AppImageKit/releases"
