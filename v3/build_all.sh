...
if command -v dpkg-deb &>/dev/null; then
    ...
    cp dist/darkie-suite_3.0.0_all.deb tool.deb 2>/dev/null || true
fi
...
cp dist/Darkie-Suite-v3-x86_64.AppImage tool.AppImage 2>/dev/null || true
...
cp dist/DarkieSuite-v3-macos.dmg tool.dmg 2>/dev/null || true
