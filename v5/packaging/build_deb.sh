...
BUILD="$DIR/build"
DEB_ROOT="$BUILD/deb/darkie-suite_5.0.0_all"
...
dpkg-deb --build "$DEB_ROOT" "$DIR/dist/darkie-suite_5.0.0_all.deb"
echo "Debian package built: dist/darkie-suite_5.0.0_all.deb"
